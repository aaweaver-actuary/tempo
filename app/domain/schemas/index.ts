...
export const queueCardSchema = z.strictObject({
  ...
  encounter_count_30d: integer.optional(),
  last_encountered_at: z.string().nullable().optional(),
...
export const repertoireOpportunitiesSchema = z.strictObject({
  opportunities: z.array(z.strictObject({
    ...
    admitted_card_id: z.string().nullable(),
    unread: z.boolean(),
    source_games: z.array(z.strictObject({ id: z.string(), url: z.string().nullable(), route: z.string() })),
    routes: z.array(z.string()),
    created_at: z.string(),
    updated_at: z.string(),
  })),
});
export const discoveriesFeedSchema = z.strictObject({
  discoveries: repertoireOpportunitiesSchema.shape.opportunities,
  total: integer,
...
export const discoveryRecommendationSchema = z.strictObject({
  ...
  candidates: z.array(z.strictObject({
    ...
    loss_cp: z.number().nullable(),
    similarity: z.string(),
    example_line_id: z.string().nullable(),
