...
const api = spawn(python, ["-m", "uvicorn", "app.main:app", "--host", "127.0.0.1", "--port", "8001"], { stdio: "inherit", env: { ...process.env, PYTHONPATH: "backend", TEMPO_TEST_INSTANCE: "disposable", TEMPO_DB_PATH: join(directory, "tempo.db") } });
